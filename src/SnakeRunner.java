...
public class SnakeRunner {
    ...
    private static final String SETTINGS_SAVE_FILE = "saves/snake_game_settings.dat";
    ...
    protected static void initialize(){
        ...
        frame.addKeyListener(new KeyListener() {
            ...
            public void keyPressed(KeyEvent e) { // key inputs : w/a/s/d for player 1, arrow keys for player 2
                ...
                if ((!gameStarted || !cont)){ // either on the home screen, lose screen, or settings
                    if (e.getKeyCode() == KeyEvent.VK_ESCAPE){ 
                        closeGame();
                    } 
                }

                if (!cont && !settingsOpen && e.getKeyCode() == KeyEvent.VK_S){ // on home screen, lose screen
                        buttonClick.setFramePosition(0);
                        buttonClick.start();
                        openSettings();
                        settingsOpen = true;
    ...
    public static void openSettings(){
        ...
        settingsRow4.add(new JLabel("<html><span style='font-size:20px;'>Wins&nbsp;&nbsp;|&nbsp;&nbsp;</span></html>"));
        settingsRow4.add(new JLabel("<html><span style='font-size:20px;'>Player_1: " + snake1Wins + "</span></html>"));
        settingsRow4.add(new JLabel("<html><span style='font-size:20px;'>&nbsp;&nbsp;&nbsp;&nbsp;Player_2: " + snake2Wins + "</span></html>"));
    ...
    public static void saveSettings(){
        try (ObjectOutputStream out = new ObjectOutputStream(new FileOutputStream(SETTINGS_SAVE_FILE))){
            out.writeObject(settingsArr);
    ...
    public static void loadSettings(){
        File settingsFile = new File(SETTINGS_SAVE_FILE);
        if (settingsFile.exists()){
            try (ObjectInputStream in  = new ObjectInputStream(new FileInputStream(SETTINGS_SAVE_FILE))){
                settingsArr = (boolean[]) in.readObject();
            } catch (IOException | ClassNotFoundException e) {
                e.printStackTrace();
            } finally{
                System.out.println("Attempted to load settings.");
            }
        } else {
    ...
    public static void runGame(){
        ...
        // only spawn fruit / boosts if at least one snake has moved
        if (snake1.getDirection() != -1 || snake2.getDirection() != -1){
    ...
    public static void loadSounds(){
        buttonClick = bufferSound("assets/buttonClick.wav");
        boostObtained = bufferSound("assets/boostObtained.wav");
        snakeDeath = bufferSound("assets/snakeDeath.wav");
        fruitEaten = bufferSound("assets/fruitEaten.wav");
        boostSpawned = bufferSound("assets/boostSpawned.wav");
        bgMusic = bufferSound("assets/backgroundMusic.wav");
        keyPress = bufferSound("assets/keyPress.wav");
    ...
    public static void loadImages(){
        ...
        playGame = new ImageIcon(new ImageIcon("assets/playGame.png").getImage().getScaledInstance(50, 50,Image.SCALE_SMOOTH));
        resetGame = new ImageIcon(new ImageIcon("assets/resetGame.png").getImage().getScaledInstance(50, 50,Image.SCALE_SMOOTH));

        loadSave = new ImageIcon(new ImageIcon("assets/loadSave.png").getImage().getScaledInstance(50, 50,Image.SCALE_SMOOTH));

        closeWindow = new ImageIcon(new ImageIcon("assets/closeWindow.png").getImage().getScaledInstance(50, 50,Image.SCALE_SMOOTH));
        settings = new ImageIcon(new ImageIcon("assets/settings.png").getImage().getScaledInstance(50,50,Image.SCALE_SMOOTH));
        back = new ImageIcon(new ImageIcon("assets/back.png").getImage().getScaledInstance(50,50,Image.SCALE_SMOOTH));

        boostExplanation = new ImageIcon(new ImageIcon("assets/boostExplanation.png").getImage().getScaledInstance(400, 260,Image.SCALE_SMOOTH));
        
        toggleAppleSpawn = new ImageIcon(new ImageIcon("assets/appleSpawn.png").getImage().getScaledInstance(50, 50,Image.SCALE_SMOOTH));
        oneApple = new ImageIcon(new ImageIcon("assets/oneApple.png").getImage().getScaledInstance(50,50,Image.SCALE_SMOOTH));


        f = new ImageIcon(new ImageIcon("assets/fruit.png").getImage().getScaledInstance(cellWidth, cellHeight, Image.SCALE_SMOOTH));
        next = new ImageIcon(new ImageIcon("assets/next.png").getImage().getScaledInstance(cellWidth, cellHeight,Image.SCALE_SMOOTH));
        nextGray = new ImageIcon(GrayFilter.createDisabledImage(next.getImage()));

        b0 = new ImageIcon(new ImageIcon("assets/boost0.png").getImage().getScaledInstance(cellWidth, cellHeight,Image.SCALE_SMOOTH));
        b0Gray = new ImageIcon(GrayFilter.createDisabledImage(b0.getImage()));

        b1 = new ImageIcon(new ImageIcon("assets/boost1.png").getImage().getScaledInstance(cellWidth, cellHeight,Image.SCALE_SMOOTH));
        b1Gray = new ImageIcon(GrayFilter.createDisabledImage(b1.getImage()));

        X2= new ImageIcon(new ImageIcon("assets/2multiplier.png").getImage().getScaledInstance(cellWidth, cellHeight,Image.SCALE_SMOOTH));

        b2 = new ImageIcon(new ImageIcon("assets/boost2.png").getImage().getScaledInstance(cellWidth, cellHeight,Image.SCALE_SMOOTH));
        b2Gray = new ImageIcon(GrayFilter.createDisabledImage(b2.getImage()));

        b3 = new ImageIcon(new ImageIcon("assets/transparency.png").getImage().getScaledInstance(cellWidth, cellHeight,Image.SCALE_SMOOTH));
        b3Gray = new ImageIcon(GrayFilter.createDisabledImage(b3.getImage()));

        b4 = new ImageIcon(new ImageIcon("assets/directionSwitch.png").getImage().getScaledInstance(cellWidth, cellHeight,Image.SCALE_SMOOTH));
        b4Gray = new ImageIcon(GrayFilter.createDisabledImage(b4.getImage()));

        X5 = new ImageIcon(new ImageIcon("assets/5multiplier.png").getImage().getScaledInstance(cellWidth, cellHeight,Image.SCALE_SMOOTH));

        yesMusic = new ImageIcon(new ImageIcon("assets/yesMusic.png").getImage().getScaledInstance(50, 50,Image.SCALE_SMOOTH));
        noMusic = new ImageIcon(new ImageIcon("assets/noMusic.png").getImage().getScaledInstance(50, 50,Image.SCALE_SMOOTH));
        keySoundsOn = new ImageIcon(new ImageIcon("assets/keySoundOn.png").getImage().getScaledInstance(50, 50,Image.SCALE_SMOOTH));
        keySoundsOff = new ImageIcon(new ImageIcon("assets/keySoundOff.png").getImage().getScaledInstance(50, 50,Image.SCALE_SMOOTH));
