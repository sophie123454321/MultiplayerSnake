...
public class SquarePanel {
    ...
    // draws eyes on a grid square with a head
    public void drawEyes(Graphics g, int px, int py, int w, int h){
        g.setColor(Color.WHITE);

        int eyeHeight = (int)(0.3*h);
        int eyeWidth = (int)(0.3*w);
        ...
        if (direction != -2 && !tail) {
            if (direction == -1) { // movement hasn't started yet
                g.fillRect(px+rectWidth-eyeWidth, y1, eyeWidth, eyeHeight);
                g.fillRect(px+rectWidth-eyeWidth, y2, eyeWidth, eyeHeight);
                g.setColor(Color.BLACK);
                g.fillRect(px+rectWidth-(int)(0.2*w), y1+(int)(0.1*h), (int)(0.2*w), (int)(0.2*h));
                g.fillRect(px+rectWidth-(int)(0.2*w), y2+(int)(0.1*h), (int)(0.2*w), (int)(0.2*h));

            } else if (direction == 0) { // up
                g.fillRect(x1, py+h-(animationStep + 1)*yStep, eyeWidth, eyeHeight);
                g.fillRect(x2, py+h-(animationStep + 1)*yStep, eyeWidth, eyeHeight);
                g.setColor(Color.BLACK);
                g.fillRect(x1+(int)(0.1*w), py+h-(animationStep + 1)*yStep+(int)(0.1*h), (int)(0.2*w), (int)(0.2*h));
                g.fillRect(x2+(int)(0.1*w), py+h-(animationStep + 1)*yStep+(int)(0.1*h), (int)(0.2*w), (int)(0.2*h));

            } else if (direction == 1) { // right
                g.fillRect(px+(animationStep + 1)*xStep-eyeWidth, y1, eyeWidth, eyeHeight);
                g.fillRect(px+(animationStep + 1)*xStep-eyeWidth, y2, eyeWidth, eyeHeight);
                g.setColor(Color.BLACK);
                g.fillRect(px+(animationStep + 1)*xStep-(int)(0.2*w), y1+(int)(0.1*h), (int)(0.2*w), (int)(0.2*h));
                g.fillRect(px+(animationStep + 1)*xStep-(int)(0.2*w), y2+(int)(0.1*h), (int)(0.2*w), (int)(0.2*h));

            } else if (direction == 2) { // down
                g.fillRect(x1, py+(animationStep + 1) * yStep-eyeHeight, eyeWidth, eyeHeight);
                g.fillRect(x2, py+(animationStep + 1) * yStep-eyeHeight, eyeWidth, eyeHeight);
                g.setColor(Color.BLACK);
                g.fillRect(x1+(int)(0.1*w), py+(animationStep + 1) * yStep-eyeHeight+(int)(0.1*h), (int)(0.2*w), (int)(0.2*h));
                g.fillRect(x2+(int)(0.1*w), py+(animationStep + 1) * yStep-eyeHeight+(int)(0.1*h), (int)(0.2*w), (int)(0.2*h));

            } else if (direction == 3) { // left
                g.fillRect(px+w-(animationStep + 1)*xStep, y1, eyeWidth, eyeHeight);
                g.fillRect(px+w-(animationStep + 1)*xStep, y2, eyeWidth, eyeHeight);
                g.setColor(Color.BLACK);
                g.fillRect(px+w-(animationStep + 1)*xStep, y1+(int)(0.1*h), (int)(0.2*w), (int)(0.2*h));
                g.fillRect(px+w-(animationStep + 1)*xStep, y2+(int)(0.1*h), (int)(0.2*w), (int)(0.2*h));

//g.fillRect(px + w - (animationStep + 1) * xStep, y1, (animationStep + 1) * xStep, rectHeight);
    ...
    public void draw(Graphics g, int px, int py, int w, int h) {
        ...
        if (!tail) {
            if (direction == -1) { // movement hasn't started yet
                ...
                g.fillRect(px,y1,rectWidth,rectHeight);
            } else if (direction == 0) { // up
